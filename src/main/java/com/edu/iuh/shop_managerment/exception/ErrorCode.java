...
public enum ErrorCode {
    ...
    PRODUCT_NOT_FOUNDED(HttpStatus.NOT_FOUND.value(), "Product not founded"),
    PRODUCT_DETAIL_NOT_FOUNDED(HttpStatus.NOT_FOUND.value(), "Product detail not founded"),
    CART_NOT_FOUNDED(HttpStatus.NOT_FOUND.value(), "Cart not founded");
