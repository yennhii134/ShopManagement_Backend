...
public class AddressService {
    ...
    public void radomDifferentAddressToMain(Address address, String userId) {
        ...
        addresses.stream().findFirst().ifPresent(randomAddress -> {
    ...
    public Address updateAddress(String userId, String addressId, Address address) {
        ...
        return Optional.ofNullable(addressId)
                ...
                .map(addressToUpdate -> {
                    addressToUpdate.setAddress(
                            address.getAddress() != null ? address.getAddress() : addressToUpdate.getAddress());
                    addressToUpdate.setStatus(
                            address.getStatus() != null ? address.getStatus() : addressToUpdate.getStatus());
